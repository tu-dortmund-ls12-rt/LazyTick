                                        ...
                                        const TickType_t period  )
    {
        ...
        #else /* CONFIG_FREERTOS_SMP */
        {
            ...
            if( pxNewTCB != NULL )
            {
                ...
                prvInitialiseNewTask( pxTaskCode, pcName, ( uint32_t ) usStackDepth, pvParameters, uxPriority, pxCreatedTask, pxNewTCB, NULL, xCoreID, period );
                                                ...
                                                const TickType_t period  )
    {
        ...
        #else /* CONFIG_FREERTOS_SMP */
        {
            ...
            if( ( pxTaskBuffer != NULL ) && ( puxStackBuffer != NULL ) )
            {
                ...
                prvInitialiseNewTask( pxTaskCode, pcName, ulStackDepth, pvParameters, uxPriority, &xReturn, pxNewTCB, NULL, xCoreID, period );
                prvAddNewTaskToReadyList( pxNewTCB );
            }
            else
            {
